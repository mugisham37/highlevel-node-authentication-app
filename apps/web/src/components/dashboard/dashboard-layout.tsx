            ...
            <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
              ...
              <nav className="mt-5 space-y-1 px-2">
                {navigation.map(item => (
                  ...
                  >
                    <div
                      className={`mr-4 ${currentPath === item.href ? 'text-primary-500' : 'text-gray-400 group-hover:text-gray-500'}`}
                    >
                      {item.icon}
                    </div>
                    {item.name}
          ...
          <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            ...
            <nav className="mt-5 flex-1 space-y-1 px-2">
              {navigation.map(item => (
                ...
                >
                  <div
                    className={`mr-3 ${currentPath === item.href ? 'text-primary-500' : 'text-gray-400 group-hover:text-gray-500'}`}
                  >
                    {item.icon}
                  </div>
                  {item.name}
